...
RSpec.describe UsersController, type: :routing do
  ...
  describe 'some resources under institutions' do
    ...
    it { expect(get: '/institutions/1/users').to route_to( routes_params.merge(controller: 'v1/users', action: 'index') ) }
    ...
    it { expect(post: '/institutions/1/users').to route_to( routes_params.merge(controller: 'v1/users', action: 'create') ) }
    it { expect(put: '/institutions/1/users/1').to route_to( routes_params.merge( controller: 'v1/users', action: 'update', id: '1') ) }
    it { expect(delete: '/institutions/1/users/1').to route_to( routes_params.merge(controller: 'v1/users', action: 'destroy', id: '1') ) }
